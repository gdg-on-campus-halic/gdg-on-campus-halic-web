    ...
    <div className="relative min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="relative z-10">
        ...
        >
          ...
          {/* Call to action - Updated with green color */}
          <motion.div 
            variants={fadeIn}
          ...
          >
            ...
            <a
              ...
              className="group relative px-8 py-3 bg-[#34A853] text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 border border-transparent overflow-hidden inline-block hover:bg-[#2D9348]"
            >
